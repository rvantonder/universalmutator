...
import universalmutator.mutatorcomby as mutatorcomby
...
def main():
    ...
    mutants = mutatorcomby.mutants(source, ruleFiles=rules, mutateTestCode=mutateTestCode, mutateBoth=mutateBoth,
    ...
    for mutant in mutants:
        ...
        print("PROCESSING MUTANT:",
              "range" + str(mutant[0]) + ":", source[mutant[0][0]:mutant[0][1]], " ==> ", mutant[1], end="...")
        if showRules:
            print("(FROM:", mutant[2][1], end=")...")
        mutatorcomby.makeMutant(source, mutant, tmpMutantName)
